...
namespace Demo.WindowsForms
{
	public partial class MainForm : Form
	{
		...
		private void Markers_CollectionChanged(object sender, GMap.NET.ObjectModel.NotifyCollectionChangedEventArgs e)
		{
			textBoxMarkerCount.Text = objects.Markers.Count.ToString();
		}

		private void Routes_CollectionChanged(object sender, GMap.NET.ObjectModel.NotifyCollectionChangedEventArgs e)
		{
		...
		private RectLatLng flightBounds = new RectLatLng(54.4955675218741, -0.966796875, 28.916015625, 13.3830987326932);
		...
		private readonly Queue<string> TcpStateNeedtraceInfo = new Queue<string>();

		private volatile bool TryTraceConnection = false;
		...
		private void connectionsWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
		{
			try
			{
				// stops immediate marker/route/polygon invalidations; call Refresh to perform
				// single refresh and reset invalidation state
				MainMap.HoldInvalidation = true;
		...
		#endregion -- tcp/ip connections demo --
		...
		private bool TryExtractLeafletjs()
		{
			try
			{
		...
		private GMapPolygon currentPolygon = null;
		...
		#endregion -- menu panels expanders --

		#region -- ui events --

		private bool UserAcceptedLicenseOnce = false;
		...
		// http://leafletjs.com/ Leaflet is a modern open-source JavaScript library for
		// mobile-friendly interactive maps Leaflet is designed with simplicity, performance and
		// usability in mind. It works efficiently across all major desktop and mobile platforms out
		// of the box
		...
		private void textBoxLatCurrent_TextChanged(object sender, EventArgs e)
		{
